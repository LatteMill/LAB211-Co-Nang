 ...
 * Class này sẽ có chức năng chứa các hàm kiểm tra dữ liệu mà người
 * dùng nhập vào
 */
public class Validation {
    ...
    /**    
     * Hàm này sẽ có chức năng kiểm tra xem người dùng có bỏ trống phần
     * nhập dữ liệu hay không
     */
     ...
     * Hàm này sẽ có chức năng kiểm tra thời gian mà người dùng nhập
     * vào
     */
    ...
    /**    
     * Hàm này sẽ kiểm tra xem thời gian bắt đầu công việc mà người
    ...
    /**
     * Hàm này sẽ có chức kiểm tra xem thời gian kết thúc công việc mà
     * người dùng nhập vào đã đúng hay chưa
     */
    ...
    /**
     * Hàm này sẽ có chức năng kiểm tra phần id mà người dùng nhập vào khi xử dụng option 2 là delete task
     */
    public int getID() {
        int id;
        do {
